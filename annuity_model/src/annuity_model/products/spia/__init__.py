...
from annuity_model.products.spia.engine import (
    SPIAContract,
    SPIAProjectionResult,
    liability_path_from_spia_projection,
    price_spia_single_premium,
)
from annuity_model.products.spia.excel import ExcelBuildSpec, build_workbook_from_spec
from annuity_model.products.spia.ui import SPIA_ADAPTER, spia_metric_formatter, spia_ui_config
