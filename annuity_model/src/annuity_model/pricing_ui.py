...
from annuity_model.liability_aggregation import padded_cashflows_on_portfolio_grid
from annuity_model.parity_constants import MODELCHECK_TOL
from annuity_model.portfolio import PolicyInput, Portfolio, PortfolioResult, RunScenario
from annuity_model.portfolio_config import portfolio_sidebar_visible
...
from annuity_model.products.rila.ui import (
...
def _build_yield_curve(
    ...
    *,
    ...
    return build_yield_curve_from_seeds(seeds, repo_root=PROJECT_ROOT)
...
def _build_mortality(
    ...
    *,
    ...
    return build_mortality_from_seeds(
        seeds, product_type=product_type, sex=sex, repo_root=PROJECT_ROOT
    )
    ...
    if run:
        try:
            ...
            if selected_product == ProductType.TERM_LIFE:
                ...
                from annuity_model import myga_projection as my_proj
                ...
                from annuity_model import fia_projection as fp_proj
                ...
                from annuity_model import va_projection as va_proj
                ...
                from annuity_model import wl_projection as wl_proj
...
def _portfolio_run_scenario_for_policies(policies: tuple[PolicyInput, ...]) -> RunScenario:
    ...
    return run_scenario_for_portfolio_policies(
        dict(st.session_state), policies, sex=sex, repo_root=PROJECT_ROOT
    )
