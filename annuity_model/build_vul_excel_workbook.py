...
def build_vul_workbook_from_spec(
    ...
    *,
    ...
    write_inputs_sheet(ws_in, InputsSheetSpec(title="Variable UL Inputs (matches model launcher / Python)", rows=rows))
    nm = (
    ...
    write_model_check_sheet(
        wb, snap_py, alm_layout=None, alm_snapshot=None, pricing_rows=vul_rows,
