...
def write_inputs_sheet(ws, spec: InputsSheetSpec) -> None:
...
def write_liability_summary_block(ws, spec: LiabilitySummaryBlockSpec) -> None:
...
def write_kv_rows(ws, rows: Iterable[tuple[str, object]], *, start_row: int = 3) -> int:
