"""Whole Life Streamlit AppTest smoke test.

See ``test_apptest_spia.py`` for the rationale -- this is the Whole Life
analog.
"""
...
@pytest.mark.ui
def test_wl_pricing_run_page_renders_without_exceptions(streamlit_apptest_module) -> None:
    ...
    select_product(at, "whole_life")
    assert_no_exceptions(at, context="select Whole Life product")
